...
public class Controller {
	...
	// laver et hotel
	public static Hotel createHotel(String navn, String adresse, int antalværelser, int badpris, int madpris,
			int wifipris) {
	...
	// laver en udflugt
	public static Udflugt Udflugt(String beskrivelse, String adresse, LocalDateTime startTid, LocalDateTime slutTid,
			int pris) {
	...
	// laver en tilmelding
	public static Tilmelding createTilmelding(String navn, String ledsagernavn, boolean foredragsholder,
	...
	public static void initStorage() {
		Hotel h1 = Controller.createHotel("Hotel-FD ", "Solnedgå", 1, 500, 250, 100);
		Hotel h2 = Controller.createHotel("Hotel-AA ", "Vibyopgår", 2, 400, 150, 100);

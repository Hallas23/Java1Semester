...
public class ArrayApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Aktuelt  : " + Arrays.toString(tabel) + " summen " + metode.sum(tabel));
        System.out.println();
        ...
        int[] a = {2, 4, 4, 6, 10, 12, 14, 18, 20, 22};
        int[] b = {2, 4, 6, 8, 3, 6, 14, 16, 18, 20, 22, 24 , 26};
        
        
        metode.makesum(a, b);
        System.out.println(Arrays.toString( metode.makesum(a, b)));
        System.out.println(( metode.hasUneven(b)));

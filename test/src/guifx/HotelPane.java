...
public class HotelPane extends GridPane {
	private TextField txfName, txfAdresse, txfBadpris, txfMadpris, txfWifipris, txfPrisPrDag, txfPrisPrDobbeltSeng,
			txfKonference;
	...
	public HotelPane() {
		...
		this.add(lblTilm, 0, 4);

		lvwTilmeldinger = new ListView<>();
		this.add(lvwTilmeldinger, 0, 5, 1, 4);

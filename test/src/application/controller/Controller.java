...
public class Controller {
	 ...
	 */
	public static Konference createKonference(LocalDate startDato, LocalDate slutDato, String adresse,
			String beskrivelse) {
	 ...
	 * 
	 * @param konference Pre: En konference skal være initialiseret.
	 */
	 ...
	 * @param slutDato
	 * @param adresse
	 * @param beskrivelse Pre: En konference skal være initialiseret.
	 */
	public static void updateKonference(Konference konference, LocalDate startDato, LocalDate slutDato, String adresse,
			String beskrivelse) {
	 ...
	 * 
	 * @param deltager Pre: En deltager skal initialiseret.
	 */
	 ...
	 * @param firmanavn
	 * @param telefonNr
	 * @param firmatelefonNr Pre: En deltager skal være initialiseret.
	 */
	 ...
	 * @param wifipris
	 * @param konference
	 * @return det initialiseret hotel. Pre: der skal være initialiseret et hotel.
	 */
	public static Hotel createHotel(String navn, String adresse, int prisprdag, int dobbeltseng, int badpris,
			int madpris, int wifipris, Konference konference) {
	 ...
	 * 
	 * @param hotel Pre: Hotellet skal være initialiseret.
	 */
	 ...
	 * @param madpris
	 * @param wifipris
	 * @param konference  Pre: hotel og konference skal være initialiseret.
	 */
	public static void updateHotel(Hotel hotel, String navn, String adresse, int prisprdag, int dobbeltseng,
			int badpris, int madpris, int wifipris, Konference konference) {
		hotel.setNavn(navn);
	 ...
	 * 
	 * @param hotel
	 * @param tilmelding Pre: Hotel og tilmelding er initialiseret.
	 */
	 ...
	 * @param pris
	 * @param konference
	 * @return den initialiseret udflugt. Pre: en konference skal være oprettet.
	 */
	public static Udflugt CreateUdflugt(String beskrivelse, String adresse, LocalDate startTid, int pris,
	 ...
	 * Sletter en udflugt.
	 * 
	 * @param udflugt Pre: en udflugt skal være initialiseret.
	 */
	 ...
	 * @param startTid
	 * @param pris
	 * @param konference  Pre: en udflugt og en konference er initialiseret.
	 */
	public static void updateUdflugt(Udflugt udflugt, String beskrivelse, String adresse, LocalDate startTid, int pris,
			Konference konference) {
	 ...
	 * 
	 * @param hotel Pre: et hoteltillæg er initialiseret.
	 */
	 ...
	 * @param bad
	 * @param mad
	 * @param wifi        Pre: et hoteltillæg skal være initialiseret.
	 */
	 ...
	 * @param ankomstdato
	 * @param afrejsedato
	 * @return den initialiseret tilmelding. Pre: en deltager skal være
	 *         initialiseret.
	 */
	public static Tilmelding createTilmelding(String navn, String ledsagernavn, boolean foredragsholder, boolean seng,
			Deltager deltager, Konference konference, LocalDate ankomstdato, LocalDate afrejsedato) {
		Tilmelding tilmelding = new Tilmelding(navn, ledsagernavn, foredragsholder, seng, deltager, konference,
	 ...
	 * 
	 * @param tilmelding Pre: en tilmelding skal være initialiseret.
	 */
	 ...
	 * @param konference
	 * @param ankomstdato
	 * @param afrejsedato     Pre: en tilmelding og konference skal være
	 *                        initialiseret.
	 */
	public static void updateTilmelding(Tilmelding tilmelding, String navn, String ledsagernavn,
			boolean foredragsholder, boolean seng, Deltager deltager, Konference konference, LocalDate ankomstdato,
	 ...
	 * 
	 * @param tilmelding
	 * @param hoteltillæg Pre: hoteltillæg og tilmelding er initialiseret.
	 */
	...
	public static void initStorage() {
		Konference k1 = Controller.createKonference(LocalDate.of(2018, 11, 27), LocalDate.of(2018, 11, 29), "Herning",
				"Konference om Herning by");
		...
		Tilmelding t1 = Controller.createTilmelding("Ole", "Bo", false, true, d1, k1, LocalDate.of(2018, 11, 27),

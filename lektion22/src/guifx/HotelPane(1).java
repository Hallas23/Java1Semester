...
public class HotelPane extends GridPane {
	private TextField txfName, txfAdresse, txfBadpris, txfMadpris, txfWifipris,txfPrisPrDobbeltSeng,
...
//		lvwhotelTillæg.getItems().setAll(Controller.getHotelTillæg());
	...
	public void updateHotel() {
		...
		if (hotel != null) {
			...
			String PrisPrDag = String.valueOf(hotel.---------());
			String PrisPrDobbeltSeng = String.valueOf(hotel-----());

...
/**
 * 
 * @author Ramsn Darvesh, Simon Hallas & Mads Hegewald
 *
 */
   ...
   */
	 ...
	 */
		...
		public static void initStorage() {
			...
			Tilmelding t1 = Controller.createTilmelding("Ole", "Bo", false, true, d1, k1, LocalDate.of(2018, 11, 27), LocalDate.of(2018, 11, 29));
